...
struct AppNotificationView: View {
    ...
    private func startProgressTimer() {
        ...
        // Note: Structs are value types, so [weak self] is not applicable.
        // The timer is invalidated in onDisappear, preventing any issues.
        timer = Timer.scheduledTimer(withTimeInterval: updateInterval, repeats: true) { timerInstance in
            if progress > 0 {
