    ...
    private var filteredModels: [any TranscriptionModel] {
        ...
        case .recommended:
            return whisperState.allAvailableModels.filter {
                let recommendedNames = ["ggml-base.en", "ggml-large-v3-turbo-q5_0", "parakeet-tdt-0.6b", "apple-speech"]
                return recommendedNames.contains($0.name)
            }.sorted { model1, model2 in
                let recommendedOrder = ["ggml-base.en", "ggml-large-v3-turbo-q5_0", "parakeet-tdt-0.6b", "apple-speech"]
