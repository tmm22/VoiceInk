...
final class FluidAudioStreamingProvider: StreamingTranscriptionProvider {
    ...
    private let logger = Logger(subsystem: AppLogger.subsystem, category: "FluidAudioStreaming")
    ...
    private func runTranscriptionPass() async {
        ...
        do {
            ...
            logger.error("Transcription pass failed: \(AppLogger.errorMetadata(error), privacy: .public)")
    ...
    private func transcribeRemainingAudio() async -> String? {
        ...
        do {
            ...
            logger.error("Final transcription failed: \(AppLogger.errorMetadata(error), privacy: .public)")
            return nil
        }
    }
