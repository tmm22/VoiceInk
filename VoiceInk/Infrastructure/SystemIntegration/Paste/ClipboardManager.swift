...
struct ClipboardManager {
    ...
    static func setClipboard(
        _ text: String, transient: Bool = false, sessionID: String? = nil,
    ...
    /// Only these metadata types are safe alongside a sanitizer's single plain-text item.
    static let plainTextPasteTypes: Set<NSPasteboard.PasteboardType> = [
        .string, sourceType, transientType, autoGeneratedType, pasteSessionType,
    ]
