...
class AssemblyAITranscriptionService: CloudTranscriptionBase, CloudTranscriptionProvider {
    ...
    private func uploadAudio(audioURL: URL, apiKey: String) async throws -> String {
        ...
        do {
            ...
            AppLogger.network.error("AssemblyAI upload decode failed: \(AppLogger.errorMetadata(error), privacy: .public)")
            throw CloudTranscriptionError.noTranscriptionReturned
        }
    }
    ...
    private func createTranscription(
        ...
        do {
            ...
            AppLogger.network.error("AssemblyAI create decode failed: \(AppLogger.errorMetadata(error), privacy: .public)")
            throw CloudTranscriptionError.noTranscriptionReturned
        }
    }
    ...
    private func pollForResult(transcriptID: String, apiKey: String) async throws -> String {
        ...
        while true {
            ...
            do {
                ...
                AppLogger.network.error("AssemblyAI status decode failed: \(AppLogger.errorMetadata(error), privacy: .public)")
