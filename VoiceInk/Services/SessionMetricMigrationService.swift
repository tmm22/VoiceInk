    ...
    func runStatsMigrationIfNeeded(modelContainer: ModelContainer) -> Task<Void, Never>? {
        ...
        return Task.detached(priority: .utility) {
            ...
            do {
                ...
                logger.error("Stats migration failed: \(AppLogger.errorMetadata(error), privacy: .public)")
            }
    ...
    func runEnhancementTokenBackfillIfNeeded(modelContainer: ModelContainer) -> Task<Void, Never>? {
        ...
        return Task.detached(priority: .utility) {
            ...
            do {
                ...
                logger.error("Enhancement token backfill failed: \(AppLogger.errorMetadata(error), privacy: .public)")
            }
