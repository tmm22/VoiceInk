...
enum PredefinedPrompts {
    ...
    static let defaultPromptId = UUID(uuidString: "00000000-0000-0000-0000-000000000001") ?? UUID()
    static let assistantPromptId = UUID(uuidString: "00000000-0000-0000-0000-000000000002") ?? UUID()
