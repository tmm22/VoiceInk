...
class TranscriptionPipeline {
    ...
    private let logger = Logger(subsystem: AppLogger.subsystem, category: "TranscriptionPipeline")
    ...
    func run(
        ...
        func finishCanceledTranscription() async {
            ...
            do {
                ...
                logger.error("Failed to save canceled transcription: \(AppLogger.errorMetadata(error), privacy: .public)")
            }
        }
        ...
        func saveTranscriptionAndPostCompletion() {
            ...
            if transcription.transcriptionStatus == TranscriptionStatus.completed.rawValue {
                do {
                    ...
                    logger.error("Failed to record session metric: \(AppLogger.errorMetadata(error), privacy: .public)")
                }
            }
