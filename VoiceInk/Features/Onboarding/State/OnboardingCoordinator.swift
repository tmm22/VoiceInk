...
final class OnboardingCoordinator: ObservableObject {
    ...
    var stage: OnboardingStage {
        if AppBrand.isCommunityEdition, storedStage == OnboardingStage.license.rawValue {
            return .trust
        }
    ...
    var totalStepCount: Int {
        OnboardingStage.baseStepCount + activeExperienceSteps.count + contextAwarenessStepCount
            + (AppBrand.isCommunityEdition ? 1 : 2)
    }
